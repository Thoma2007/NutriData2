        ...
        do {
            ...
            while (true) {
                try {
                    ...
                    opcionAlimento = Integer.parseInt(
                            JOptionPane.showInputDialog("Seleccione un número de alimento"));
            ...
            while (true) {
                try {
                    ...
                    consumo.setCantidad(Integer.parseInt(
            ...
            consumo.setTipoComida(
                    JOptionPane.showInputDialog("Tipo de comida: "));

            consumo.setFecha(
                    JOptionPane.showInputDialog("Fecha: "));

            //Aqui guardamos el consumo en el ArrayList
