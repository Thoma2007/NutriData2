        ...
        try {
            ...
            while (true) {
                try {
                    ...
                    JOptionPane.showMessageDialog(
                            null,
                            "Error: Debe ingresar un número entero para la edad.",
                            "Dato invalido",
            ...
            while (true) {
                try {
                    ...
                    JOptionPane.showMessageDialog(
                            null,
                            "Error: Debe ingresar un valor numérico válido para el peso (Ej: 70.5).",
                            "Dato Inválido",
                            JOptionPane.ERROR_MESSAGE
                    );
                }
            ...
            while (true) {
                try {
                    ...
                    JOptionPane.showMessageDialog(
                            null,
                            "Error: Debe ingresar un valor numérico válido para la altura (Ej: 1.75).",
                            "Dato Inválido",
                            JOptionPane.ERROR_MESSAGE
                    );
                }
            ...
            ArrayList<ConsumoAlimento> listaConsumos =
                    new ArrayList<>();

            //Creamos el catalogo
            CatalogoAlimentos catalogo =
                    new CatalogoAlimentos();
            ...
            */
            ...
            do {
                ...
                //Mostramos el catalogo pero con scroll
                JTextArea areaTexto =
                        new JTextArea(menu);
                ...
                while (true) {
                    ...
                    try {
                        ...
                        opcionAlimento =
                                Integer.parseInt(
                                        JOptionPane.showInputDialog(
                                                "Seleccione un número de alimento"
                                        )
                                );
                        ...
                        if (opcionAlimento >= 1
                            ...
                            JOptionPane.showMessageDialog(
                                    null,
                                    "Error: El número seleccionado no está en el catálogo.",
                                    "Rango Inválido",
                                    JOptionPane.ERROR_MESSAGE
                            );
                        }
                ...
                //Crear consumo
                ConsumoAlimento consumo =
                        new ConsumoAlimento();

                //Guardamos los datos del consumo
                ...
                //Aqui guardamos el consumo
                listaConsumos.add(consumo);

                //Ciclo de los consumos
                opc =
                        JOptionPane.showConfirmDialog(
                                null,
                                "Desea agregar otro alimento"
                        );

            } while (opc == 0);

            //Ahora analizamos el consumo
            AnalizadorNutricional analizador =
                    new AnalizadorNutricional();

            analizador.analizarConsumos(
                    listaConsumos
            );
